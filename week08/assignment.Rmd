...
3. Question: How do the patterns of HPTMs and chromatin accessibility change across forebrain development? We would like to address this question by integrating the ChIP-seq and ATAC-seq data for each timepoint and evaluate their changes over development. 
